...
if !exists("batch_cmdextversion")
  let batch_cmdextversion = 2
endif
...
" Dosbat keywords
syn keyword batchStatement	goto call exit
...
syn match dosbatchCmd		"(\s*'[^']*'"lc=1 contains=dosbatchString,dosbatchVariable,dosBatchArgument,@dosbatchNumber,dosbatchImplicit,batchStatement,dosbatchConditional,dosbatchRepeat,dosbatchOperator
...
hi def link batchStatement	Statement
hi def link dosbatchCommands	batchStatement
